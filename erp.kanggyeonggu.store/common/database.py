...
# 서비스별 스키마 설정
SCHEMAS = {
    "customer": "kanggyeonggu_customer",
    "dashboard": "kanggyeonggu_dashboard", 
    "order": "kanggyeonggu_order",
    "report": "kanggyeonggu_report",
    "setting": "kanggyeonggu_setting",
    "stock": "kanggyeonggu_stock",
}
