            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium mb-2">너비 (Width)</label>
                            <select
                                value={width}
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-2">높이 (Height)</label>
                            <select
                                value={height}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium mb-2">스텝 (Steps)</label>
                            <input
                                type="number"
                                value={steps}
                    ...
                    {loading && (
                        <div className="flex items-center justify-center h-64 bg-gray-100 rounded-lg">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600">이미지를 생성하고 있습니다...</p>
                                <p className="text-sm text-gray-500 mt-2">잠시만 기다려주세요 (30초~2분 소요)</p>
                            </div>
                        </div>
                    )}
                    ...
                    {result && !loading && (
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                                <h3 className="font-semibold mb-2">생성 정보</h3>
