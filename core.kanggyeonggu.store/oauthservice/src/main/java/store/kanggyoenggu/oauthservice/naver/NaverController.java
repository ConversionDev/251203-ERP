package store.kanggyoenggu.oauthservice.naver;
...
public class NaverController {
    ...
    public NaverController(NaverOAuthService naverOAuthService, JwtService jwtService, store.kanggyoenggu.oauthservice.service.UserService userService) {
