package store.kanggyoenggu.oauthservice.kakao;
...
public class KakaoController {
    ...
    public KakaoController(KakaoOAuthService kakaoOAuthService, JwtService jwtService, store.kanggyoenggu.oauthservice.service.UserService userService) {
